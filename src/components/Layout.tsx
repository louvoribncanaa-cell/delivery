          ...
          <div className="w-full max-w-[1600px] mx-auto flex items-center gap-6">
            <div className="flex-1 max-w-xl">
              <div className="relative">
                ...
                <input
                  className="h-12 w-full rounded-2xl border border-slate-200 bg-slate-50/80 pr-4 text-[14px] text-slate-700 placeholder:text-slate-400 outline-none transition-all focus:border-[#14917a] focus:bg-white focus:shadow-[0_0_0_3px_rgba(20,145,130,0.1)]"
