  ...
  return (
    <Layout title="Histórico">
      ...
      <div className="mb-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <div className="relative sm:col-span-2 lg:col-span-1"><Search className="pointer-events-none absolute left-3 top-1/2 z-10 h-5 w-5 -translate-y-1/2 text-slate-400" /><input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Buscar pedido ou cliente" className="w-full rounded-xl border border-slate-200 bg-white py-2.5 pr-3 text-sm" style={{ paddingLeft: '64px' }} /></div>
